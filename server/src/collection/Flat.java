...
public class Flat implements Comparable<Flat>, Serializable {
    ...
    public Flat(String[] data) throws Exception {
        ...
        this.area = Long.parseLong(data[6]);
        this.numberOfRooms = Integer.parseInt(data[7]);
        this.furnish = Furnish.valueOf(data[8]);
        this.view = View.valueOf(data[9]);
        this.transport = Transport.valueOf(data[10]);
        this.house = new House(data[11], Integer.parseInt(data[12]), Long.parseLong(data[13]));
    }
